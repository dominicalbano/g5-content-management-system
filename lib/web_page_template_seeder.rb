class WebPageTemplateSeeder
  ...
  def seed
    ...
    if @website && @instructions
      template = @is_home ? @website.create_web_home_template(web_template_params) : @website.web_page_templates.create(web_template_params)
