...
shared_examples_for SettingColumnWidgetGardenWidgets do
  describe "When availble_garden_widgets setting" do
    ...
    describe "#after_destroy" do
      it "destroy's the setting's widget's child widgets" do
        described_instance.should_receive(:destroy_column_widget_widgets)
...
describe Setting do
  it_behaves_like SettingColumnWidgetGardenWidgets
end
